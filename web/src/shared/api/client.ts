...
export type UpsertMealTemplateRequest = MealDto<"UpsertMealTemplateRequest">;
export type UpsertMealTemplateResponse = MealDto<"UpsertMealTemplateResponse">;
export type ReorderMealTemplatesRequest = MealDto<"ReorderMealTemplatesRequest">;
...
export type ListBestSetsResponse = TrainingDto<"ListBestSetsResponse">;
export type LastSessionSetDTO = TrainingDto<"LastSessionSetDTO">;
export type LastSessionSetsByExerciseDTO = TrainingDto<"LastSessionSetsByExerciseDTO">;
export type ListLastSessionSetsResponse = TrainingDto<"ListLastSessionSetsResponse">;
