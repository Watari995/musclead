...
export function Button({
  ...
  const variants = {
    ...
    ghost:
      "bg-[var(--color-surface)] text-[var(--color-ink)] border border-[var(--color-line)] hover:bg-[var(--color-surface-alt)]",
    danger:
      "bg-[var(--color-surface)] text-[var(--color-accent)] border border-[var(--color-line)] hover:bg-[var(--color-surface-alt)]",
  };
  return (
    <button
      {...props}
